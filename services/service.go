...
func GetPost(w http.ResponseWriter, r *http.Request) {
	...
	sqlStmt := `SELECT * FROM post WHERE id=$1`
...
func CreatePost(w http.ResponseWriter, r *http.Request) {
	...
	sqlStmt := `INSET INTO post(title, body) VALUES($1, $2) RETURNING id`
...
func UpdatePost(w http.ResponseWriter, r *http.Request) {
	...
	id := 0
	sqlStmt := `UPDATE post SET title=$1, body=$2 WHERE id=$3 RETURNING id`
